...
if __name__ == '__main__':
    with app.app_context():
        ...
        # db.create_all()
        db.session.commit()
        m = MayBay(loai_may_bay='AIRBUS A330', so_luong_cho_ngoi=70)
        n = MayBay(loai_may_bay='AIRBUSA350', so_luong_cho_ngoi=70)
        e = MayBay(loai_may_bay='BOEING787', so_luong_cho_ngoi=100)
        ...
        u = User(name='Vang', username='admin', password=password,
                 ...
                 avatar='https://res.cloudinary.com/dy2dgfaiq/image/upload/v1712572190/rdwkbsepefqwzashuhvi.png')
        u = ChuyenBay(ten_chuyen_bay='HN-HCM', san_bay_di_id=1, san_bay_den_id=2)
        db.session.add(u)
        db.session.commit()
