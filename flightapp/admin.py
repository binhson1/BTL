...
from flightapp.models import MayBay, SanBay, LichChuyenBay, ChuyenBay, UserRole, User
from flightapp import db, app, dao
...
class FlightScheduleView(AuthenticatedModelView):
    ...
    column_list = ['so_luong_hang_ve_1', 'so_luong_hang_ve_2', 'price', MayBay.loai_may_bay,
                              ChuyenBay.ten_chuyen_bay, 'ngay_gio']
